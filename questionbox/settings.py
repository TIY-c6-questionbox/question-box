"""
Django settings for questionbox project on Heroku. Fore more info, see:
...
INSTALLED_APPS = (
    'questionboard.apps.QuestionboardConfig',
...
path_url = os.environ.get('QUESTION_DATABASE_URL')
